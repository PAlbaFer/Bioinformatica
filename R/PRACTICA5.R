...
# ¿Qué pasa si hacemos una transformación logarítmica de los datos? ¿Para qué sirve?
# 1 -> Transforma los datos para que sean visualmente más uniformes
data2 = log2(data)
...
# ¿Qué es un boxplot?
# 2 -> Es una representación gráfica de datos por cuartiles. Musetra Q1, mediana y Q3 con cajas, 
# +- 1,5*RIC (rango intercuartílico) con los "bigotes", y los valores extramos con puntos
...
# 6 -> Porque hemos comparado los niveles de expresión de los genes ko con los de wt, por lo que
# en un gen sobreexpresado (en ko) la expresión es órdenes de magnitud menor en wt que en ko.
...
# 7 -> Filtrado de datos, datos de filas, daros de columnas, colores
